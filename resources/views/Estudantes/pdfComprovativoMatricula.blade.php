...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-9">
                <p><b>Nome do Estudante:</b>&nbsp;{{$estudante->nome}} &nbsp;{{$estudante->apelido}} &nbsp;&nbsp;&nbsp; <b>Nº de Estudante:</b> &nbsp;{{$estudante->codigo}} </p>
     ...
     <div class="row">
        ...
        <div class="row">
            <div class="col-xs-9">
                <p><b>Nome do Estudante:</b>&nbsp;{{$estudante->nome}} &nbsp;{{$estudante->apelido}} &nbsp;&nbsp;&nbsp; <b>Codigo:</b> &nbsp;{{$estudante->codigo}} </p>
                <p><b>Nº do BI:</b> &nbsp;{{$estudante->BI}} &nbsp;&nbsp;&nbsp; </p>
                <p align="right"><b>Data:</b>&nbsp;{{ date('d-m-Y H:i:s') }}</p>
            </div>
