...
<div class="row">
    ...
    <form role="form" action="{{route('store_candidato')}}" id="createEstudante_form" enctype="multipart/form-data" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">

        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Ficha de Candidato</h3>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <input min="1970-01-01" max="2006-12-31" class="form-control" type="date" name="data_nac">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <h5 align="center"><b>Documentação Indivdual</b></h5>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="num_contribuinte" required>
                                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="num_seguranca_social" required>
                                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                                    </div>
                                                </div>
...
-->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="">Universidade onde obteve formação:</label>
