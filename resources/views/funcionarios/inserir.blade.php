                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <input min="1920-01-01" max="2006-12-31" class="form-control" type="date" name="data_nac">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <input name="numero_filhos" type="text" class="form-control">
                                                <span class="text-danger">{{ $errors->first('genero') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="BI" name="numero_bi" required>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input min="2010-08-14" max="{{$date}}" class="form-control" type="date" name="data_emissao_bi" required>
                                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input min="{{$date}}" class="form-control" type="date" name="data_validade_bi" required>
                                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="nome_pai" required>
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="nome_mae" required>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="categoria_prof" type="text" class="form-control">
                                        <span class="text-danger">{{ $errors->first('genero') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Tempo de experiência profissional </label>
                                        <input name="tempo_exp_prof" class="form-control" type="text">
                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                    </div>

                                    <div class="form-group">
                                        <label>Data Admissão </label>
                                        <input min="2010-08-14" max="{{$date}}" class="form-control" type="date" name="data_admissao">
                                        <span class="text-danger">{{ $errors->first('BI') }}</span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="categoria_ocupacional" id="categoria_ocupacional">
                                        <span class="text-danger">{{ $errors->first('genero') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input id="habilitacoes[]" name="habilitacoes[]" type="checkbox" value="{{$hab->id}}">{{$hab->nome}}
                                            </label>
                                        </div>
                                        @endforeach
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input id="idiomas[]" name="idiomas[]" type="checkbox" value="{{$idioma->id}}">{{$idioma->nome}}
                                            </label>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group input-group">
                                                ...
                                                <input class="form-control" type="text" id="telefone1" name="telefone1" placeholder="Telef. 1" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group input-group">
                                                <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                                <input class="form-control" type="tel" id="telefone2" name="telefone2" placeholder="Telef. 2" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!--    <div class="form-group">
                                        <label>Provincia</label>
                                        <select id="provincia_morada" name="provincia_morada" class="form-control">
                                            @foreach($provincias as $provincia)
                                            <option value="{{$provincia->id}}">{{$provincia->nome}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label>Municipio</label>
                                        <select id="municipio_morada" name="municipio_morada" class="form-control">
                                            <option value="-">-</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="zona_morada" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input id="documentos[]" name="documentos[]" type="checkbox" value="{{$documento->id}}">{{$documento->nome}}
                                            </label>
                                        </div>
                                        @endforeach
