...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Actualizar Departamentos</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
           ...
           Departamentos
				    ...
				    <div class="row">
				        <div class="col-lg-6">
							...
							<form role="form" action="{{route('updateDepartamentos',$departamento->id)}}" id="createDepartamento_form" method="PUT">

								<div class="form-group">
									<label>Identificador</label>
								    <input class="form-control" type="text" name="identificador" value="{{ $departamento->identificador}}" required>
								</div>
