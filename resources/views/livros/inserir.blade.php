...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Registrar Livro</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <form role="form" action="{{route('storeLivro')}}" id="createEstudante_form" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="codBarra">
                            </div>
                            <div class="form-group">
