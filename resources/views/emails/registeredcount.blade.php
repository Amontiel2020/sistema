<div>Pagamentos do dia de Hoje</div>
 <p>Inscrição: {{number_format($totalInscricao,2,',','.') }}</p>
<p> Matricula:  {{number_format($totalMatricula,2,',','.') }}</p>
<p> Propinas:  {{number_format($totalPropinas,2,',','.') }}</p>
<p> ---------------------------------</p>
